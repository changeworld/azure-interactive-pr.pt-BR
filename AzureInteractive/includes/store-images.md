...
O aplicativo Web requer uma API recuperar metadados de imagem do Cosmos DB. Nas etapas a seguir. Você criará uma função de gatilho HTTP que usa uma associação de entrada do Cosmos DB para consultar a coleção de bancos de dados.
